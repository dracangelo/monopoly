...
class Command(BaseCommand):
    help = 'Populate the board with properties and special tiles'

    def handle(self, *args, **kwargs):
        # Get or create the Monopoly board
        ...
        for data in spaces_data:
            if data["space_type"] == "PROPERTY":
                property, created = Property.objects.get_or_create(name=data["property_name"])
        ...
        self.stdout.write(self.style.SUCCESS('Successfully populated the board.'))
